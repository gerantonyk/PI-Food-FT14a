  ...
  return (
      ...
      <div className="recipeDetail">
          ...
          <div className="info">
            ...
            <div><span className = 'thick'>Resumen:</span> {recipeDetail.summary && recipeDetail.summary.replace(/<[^>]+>/g, '')} ºC</div>
            <div><span className = 'thick'>Puntuacion:</span> {recipeDetail.score}</div>
            <div><span className = 'thick'>Nivel de salud: </span>{recipeDetail.healthyness} km/h</div>
